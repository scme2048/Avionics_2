...
# Sat Mar 12 15:01:00 2016

# (NEW DESIGN)

# create a new design
new_design -name "read_buffer" -family "ProASIC3L"

# set default back-annotation base-name
set_defvar "BA_NAME" "read_buffer_ba"
...
set_defvar "EXPORT_STATUS_REPORT_FILENAME" "read_buffer.rpt"
...
import_source  \
-format "edif" -edif_flavor "GENERIC" -netlist_naming "VERILOG" {../../synthesis/read_buffer.edn}

# export translation of original netlist
export -format "verilog" {../../synthesis/read_buffer.v}
